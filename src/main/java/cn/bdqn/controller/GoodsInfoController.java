...
import cn.bdqn.service.goodsinfo.GoodsInfoService;
...
public class GoodsInfoController extends BaseController{
	...
	public Object getGoodsInfo(@RequestParam(value="id",required=false) String id){
		...
		if(null == id || "".equals(id)){
			...
			try {
				...
				cjson = JSONObject.toJSONString(goodsInfo, SerializerFeature.WriteDateUseDateFormat);
			} catch (Exception e) {
				e.printStackTrace();
				return "failed";
			}
	...
	public Object modifyState(HttpSession session,@RequestParam String state){
		...
		if(null == state || "".equals(state)){
			...
			JSONObject goodsInfoObject = JSONObject.parseObject(state);
			GoodsInfo stateObjGoodsInfo =  (GoodsInfo)JSONObject.toJavaObject(goodsInfoObject, GoodsInfo.class);
			try {
