...
import cn.bdqn.pojo.MessageReply;
import cn.bdqn.pojo.Reply;
import cn.bdqn.pojo.User;
import cn.bdqn.service.leavemessage.LeaveMessageService;
import cn.bdqn.service.reply.ReplyService;
			...
			if(null == id || "".equals(id)){
				...
				try {
					...
					if(rList == null){
						...
						result = JSONArray.toJSONString(rList);
					}
				} catch (Exception e) {
					result = "failed";
				}
