...
<!-- external javascript
	...
	<!-- rich tex${path}t editor library -->
	...
	<script src="${path}/statics/js/json2.js"></script>
	
	<!-- 华丽丽滴分割线 北大青鸟 start 2014-->
	
	<!-- add by bdqn_hl 2013-2-27 start multiple file ajaxfileupload plugin-->
	<script src="${path}/statics/js/ajaxfileupload.js"></script>
	<!-- add by bdqn_hl 2013-2-27 end-->
	<!-- add by bdqn_hl 2013-3-17 start WdatePicker plugin-->
	<script type="text/javascript" src="${path}/statics/medire/WdatePicker.js"></script>
